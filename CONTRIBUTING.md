# Contributing to AmpCloud

Thank you for your interest in contributing to AmpCloud! This document provides guidelines and information for contributors.
...
2. Open a new issue with:
   ...
   - Relevant log files (`X:\AmpCloud-Bootstrap.log`, `X:\AmpCloud-Engine.log`)
...
### PowerShell (Trigger.ps1, Bootstrap.ps1, AmpCloud.ps1)
...
3. **AmpCloud.ps1:** Test with the `-NoReboot` flag (if available) or in a sacrificial VM

> **Warning:** `AmpCloud.ps1` partitions and formats disks. Never test on a machine with data you want to keep.
...
- **Status JSON** — do not add sensitive data to `AmpCloud-Status.json`
...
By contributing to AmpCloud, you agree that your contributions will be licensed under the [MIT License](LICENSE).
