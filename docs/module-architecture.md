...
| **Nova.Auth** | M365/Entra ID OAuth2 authentication (device code + WebView2 + kiosk Edge flows) | `Install-WebView2SDK`, `Show-WebView2AuthPopup`, `Invoke-M365DeviceCodeAuth`, `Update-M365Token`, `Invoke-KioskEdgeAuth`, `Invoke-KioskDeviceCodeAuth`, `Invoke-KioskM365Auth` |
